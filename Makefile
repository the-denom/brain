...
SIMAPP = ./app
HTTPS_GIT := https://github.com/cdbo/brain.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=brain \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=braind \
		  -X github.com/cdbo/brain/app.Bech32Prefix=brain \
